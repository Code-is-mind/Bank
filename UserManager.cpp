...
public:
    UserManager() {
        User user1("dara", "123", 1);
        User user2("lina", "123", 2);
        users[count++] = user1;
        users[count++] = user2;
    }
    ...
    //    User* account;
    //    ofstream outFile;
    //    outFile.open("account2.text", ios::binary);
    //    for (int i = 0; i < count; i++) {
    //        account = accounts[i];
    //        outFile.write(reinterpret_cast<char*> (account), sizeof(User));
    //    }
    //    outFile.close();
    //}
    ...
    //    //int count = 0;
    //    ifstream inFile;
    //    inFile.open("account2.text", ios::binary);
    //    if (!inFile)
    //    {
    ...
    //    while (inFile.read(reinterpret_cast<char*> (&account), sizeof(BankAcUcount)))
    //    {
